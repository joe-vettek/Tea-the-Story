...
public final class TeaStoryFluidTagProvider extends FluidTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        tag(TeaTags.Fluids.DRINK).add(FluidRegistry.BOILING_WATER_STILL.get(), FluidRegistry.SUGARY_WATER_STILL.get(), FluidRegistry.WEAK_BLACK_TEA_STILL.get(), FluidRegistry.BLACK_TEA_STILL.get(), FluidRegistry.STRONG_BLACK_TEA_STILL.get(),
