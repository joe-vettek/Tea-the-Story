...
public final class TeaStoryRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegister.STONE_STOVE.get()).define('x', Tags.Items.STONE).define('#', BlockEntityRegister.DIRT_STOVE.get()).pattern("xxx").pattern("x#x").pattern("xxx").group("stove").unlockedBy("has_dirt", has(TeaTags.Items.DIRT)).save(consumer);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ItemRegister.SHREDDED_CUCUMBER_SALAD.get()).requires(BlockRegister.WOODEN_BOWL_ITEM.get()).requires(BlockRegister.CUCUMBER.get()).requires(Items.SHEARS).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(consumer);
        ...
        DrinkRecipeBuilder.boilingRecipe(FluidRegistry.WEAK_BLACK_TEA_STILL.get(), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF)).build(consumer);
        ...
        DrinkRecipeBuilder.drinkRecipe(FluidRegistry.BLACK_TEA_STILL.get(), FluidIngredient.fromFluid(FluidRegistry.WEAK_BLACK_TEA_STILL.get(), 500), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF)).build(consumer, "teastory:weak_to_black_tea");
        DrinkRecipeBuilder.boilingRecipe(FluidRegistry.BLACK_TEA_STILL.get(), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF)).build(consumer);
        ...
        DrinkRecipeBuilder.drinkRecipe(FluidRegistry.STRONG_BLACK_TEA_STILL.get(), FluidIngredient.fromFluid(FluidRegistry.BLACK_TEA_STILL.get(), 500), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_BLACK_TEA_LEAF)).build(consumer);

        DrinkRecipeBuilder.boilingRecipe(FluidRegistry.WEAK_GREEN_TEA_STILL.get(), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF)).build(consumer);
        ...
        DrinkRecipeBuilder.drinkRecipe(FluidRegistry.GREEN_TEA_STILL.get(), FluidIngredient.fromFluid(FluidRegistry.WEAK_GREEN_TEA_STILL.get(), 500), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF)).build(consumer, "teastory:weak_to_green_tea");
        DrinkRecipeBuilder.boilingRecipe(FluidRegistry.GREEN_TEA_STILL.get(), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF)).build(consumer);
        ...
        DrinkRecipeBuilder.drinkRecipe(FluidRegistry.STRONG_GREEN_TEA_STILL.get(), FluidIngredient.fromFluid(FluidRegistry.GREEN_TEA_STILL.get(), 500), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_GREEN_TEA_LEAF)).build(consumer);

        DrinkRecipeBuilder.boilingRecipe(FluidRegistry.WEAK_WHITE_TEA_STILL.get(), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF)).build(consumer);
        DrinkRecipeBuilder.drinkRecipe(FluidRegistry.WHITE_TEA_STILL.get(), FluidIngredient.fromFluid(FluidRegistry.WEAK_WHITE_TEA_STILL.get(), 500), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF)).build(consumer, "teastory:weak_to_white_tea");
        DrinkRecipeBuilder.boilingRecipe(FluidRegistry.WHITE_TEA_STILL.get(), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF)).build(consumer);
        DrinkRecipeBuilder.drinkRecipe(FluidRegistry.STRONG_WHITE_TEA_STILL.get(), FluidIngredient.fromFluid(FluidRegistry.WHITE_TEA_STILL.get(), 500), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(TeaTags.Items.CROPS_WHITE_TEA_LEAF)).build(consumer);
        ...
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(TeaTags.Items.CROPS_CUCUMBER), FluidIngredient.EMPTY, new FluidStack(FluidRegistry.CUCUMBER_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:cucumber_juice");
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(TeaTags.Items.CROPS_GRAPE), FluidIngredient.EMPTY, new FluidStack(FluidRegistry.GRAPE_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:grape_juice");
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(TeaTags.Items.CROPS_SUGAR_CANE), FluidIngredient.EMPTY, new FluidStack(FluidRegistry.SUGAR_CANE_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:sugar_cane_juice");
        ...
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(TeaTags.Items.CROPS_APPLE), FluidIngredient.EMPTY, new FluidStack(FluidRegistry.APPLE_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:apple_juice");
