...
import xueluoanping.teastory.world.modifier.AddFeaturesByFilterBiomeModifier;
...
public class ModBiomeModifiers {
    public static DeferredRegister<Codec<? extends BiomeModifier>> BIOME_MODIFIER_SERIALIZERS =
            DeferredRegister.create(ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, TeaStory.MODID);
    ...
    private static ResourceKey<BiomeModifier> createKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, TeaStory.rl(name));
    }
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(WILD_RICE, new AddFeaturesByFilterBiomeModifier(
                new OrHolderSet<>(List.of(holderGetter.getOrThrow(BiomeTags.IS_RIVER), holderGetter.getOrThrow(Tags.Biomes.IS_SWAMP))),
                Optional.empty(),
                Optional.of(0.3f),
                Optional.empty(),
                Optional.of(0.5f),
        ...
        context.register(WILD_GRAPE, new AddFeaturesByFilterBiomeModifier(
                new OrHolderSet<>(List.of(holderGetter.getOrThrow(Tags.Biomes.IS_DRY_OVERWORLD), HolderSet.direct(holderGetter.getOrThrow(Biomes.FLOWER_FOREST)))),
                Optional.empty(),
                Optional.of(0.1f),
                Optional.of(0.85f),
                Optional.empty(),
        ...
        context.register(WILD_BITTER_GOURD, new AddFeaturesByFilterBiomeModifier(
                new AndHolderSet<>(List.of(holderGetter.getOrThrow(Tags.Biomes.IS_HOT_OVERWORLD), holderGetter.getOrThrow(BiomeTags.IS_FOREST))),
                Optional.empty(),
                Optional.of(0.1f),
                Optional.empty(),
                Optional.of(0.45f),
        ...
        context.register(WILD_TEA_PLANT, new AddFeaturesByFilterBiomeModifier(
                holderGetter.getOrThrow(Tags.Biomes.IS_SLOPE),
                Optional.empty(),
                Optional.of(0.1f),
                Optional.empty(),
                Optional.of(0.45f),
        ...
        context.register(GRASS_BLOCK_WITH_HOLE, new AddFeaturesByFilterBiomeModifier(
                holderGetter.getOrThrow(BiomeTags.IS_FOREST),
                Optional.empty(),
                Optional.of(0.4f),
                Optional.empty(),
                Optional.of(0.4f),
