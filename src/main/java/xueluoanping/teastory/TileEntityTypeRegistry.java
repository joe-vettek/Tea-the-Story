...
public class TileEntityTypeRegistry {
    ...
    public static RegistryObject<Block> STOVE = ModBlocks.register("stove", () -> new StoveBlock(Block.Properties.copy(Blocks.GRASS).strength(0.6F)));
    public static RegistryObject<Item> STOVE_ITEM = ModItems.register("stove", () -> new BlockItem(STOVE.get(), new Item.Properties()));
    public static RegistryObject<BlockEntityType<StoveTileEntity>> STOVE_TYPE = DRBlockEntities.register("stove",
            () -> BlockEntityType.Builder.of(StoveTileEntity::new, STOVE.get()).build(null));
    ...
    public static RegistryObject<Block> BAMBOO_TRAY = ModBlocks.register("bamboo_tray", () -> new BambooTrayBlock(Block.Properties.copy(Blocks.GRASS).strength(0.6F)));
    ...
    public static RegistryObject<Block> DRINK_MAKER = ModBlocks.register("drink_maker", () -> new DrinkMakerBlock(Block.Properties.copy(Blocks.GRASS).strength(0.6F)));
    ...
    public static RegistryObject<Block> STONE_ROLLER = ModBlocks.register("stone_roller", () -> new StoneRollerBlock(Block.Properties.copy(Blocks.GRASS).strength(0.6F)));
