...
public final class TeaStoryRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, BlockEntityRegistry.BAMBOO_TRAY.get()).define('x', ItemRegister.BAMBOO_PLANK.get()).define('#', Items.BAMBOO).pattern("# #").pattern("#x#").group("bamboo_tray").unlockedBy("has_bamboo_plank", has(ItemRegister.BAMBOO_PLANK.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, BlockEntityRegistry.WOODEN_TRAY.get()).define('#', Tags.Items.RODS_WOODEN).pattern("# #").pattern("###").group("wooden_tray").unlockedBy("has_rod", has(Tags.Items.RODS_WOODEN)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegistry.IRON_KETTLE.get()).define('*', Items.BUCKET).define('x', Tags.Items.INGOTS_IRON).pattern(" x ").pattern("x*x").pattern("xxx").group("iron_kettle").unlockedBy("has_iron", has(Tags.Items.INGOTS_IRON)).save(consumer);

        // Craft Block Recipes 工艺方块配方
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegistry.DIRT_STOVE.get()).define('x', NormalTags.Items.DIRT).pattern("xxx").pattern("x x").pattern("xxx").group("stove").unlockedBy("has_dirt", has(NormalTags.Items.DIRT)).save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegistry.STONE_STOVE.get()).define('x', Tags.Items.STONES).define('#', BlockEntityRegistry.DIRT_STOVE.get()).pattern("xxx").pattern("x#x").pattern("xxx").group("stove").unlockedBy("has_dirt", has(NormalTags.Items.DIRT)).save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegistry.DRINK_MAKER.get()).define('x', ItemTags.PLANKS).define('#', Tags.Items.RODS_WOODEN).pattern("# #").pattern("xxx").group("drink_maker").unlockedBy("has_planks", has(ItemTags.PLANKS)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegistry.STONE_MILL.get()).define('#', Blocks.SMOOTH_STONE_SLAB).define('*', Blocks.SMOOTH_STONE).define('/', Tags.Items.RODS_WOODEN).pattern(" / ").pattern(" * ").pattern("###").group("stone_mill").unlockedBy("has_smooth_stone", has(Blocks.SMOOTH_STONE)).save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegistry.STONE_ROLLER.get()).define('#', Blocks.SMOOTH_STONE_SLAB).define('*', Blocks.SMOOTH_STONE).define('/', Tags.Items.RODS_WOODEN).define('+', BlockRegister.WOODEN_FRAME.get()).pattern(" / ").pattern(" +*").pattern("###").group("stone_roller").unlockedBy("has_smooth_stone", has(Blocks.SMOOTH_STONE)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockEntityRegistry.WOODEN_BARREL.get()).define('#', ItemTags.PLANKS).define('*', ItemTags.WOODEN_SLABS).pattern("* *").pattern("# #").pattern("###").group("wooden_barrel").unlockedBy("has_planks", has(ItemTags.PLANKS)).save(consumer);
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ItemRegister.CLAY_TEAPOT.get()), RecipeCategory.MISC, BlockEntityRegistry.PORCELAIN_TEAPOT.get(), 0.2F, 200).unlockedBy("has_clay_teapot", has(ItemRegister.CLAY_TEAPOT.get())).save(consumer);
        ...
        DrinkRecipeBuilder.boilingRecipe(FluidIngredient.single(FluidRegistry.WEAK_BLACK_TEA_STILL.get()), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF)).build(consumer);
        DrinkRecipeBuilder.boilingRecipe(FluidIngredient.single(FluidRegistry.BLACK_TEA_STILL.get()), Ingredient.of(ItemRegister.BLACK_TEA_BAG.get())).build(consumer, "teastory:black_tea_bag");
        DrinkRecipeBuilder.drinkRecipe(FluidIngredient.single(FluidRegistry.BLACK_TEA_STILL.get()), SizedFluidIngredient.of(FluidRegistry.WEAK_BLACK_TEA_STILL.get(), 500), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF)).build(consumer, "teastory:weak_to_black_tea");
        ...
        DrinkRecipeBuilder.boilingRecipe(FluidIngredient.single(FluidRegistry.STRONG_BLACK_TEA_STILL.get()), Ingredient.of(ItemRegister.BLACK_TEA_BAG.get()), Ingredient.of(ItemRegister.BLACK_TEA_BAG.get())).build(consumer, "teastory:strong_black_tea_bag");
        DrinkRecipeBuilder.drinkRecipe(FluidIngredient.single(FluidRegistry.STRONG_BLACK_TEA_STILL.get()), SizedFluidIngredient.of(FluidRegistry.BLACK_TEA_STILL.get(), 500), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_BLACK_TEA_LEAF)).build(consumer);

        DrinkRecipeBuilder.boilingRecipe(FluidIngredient.single(FluidRegistry.WEAK_GREEN_TEA_STILL.get()), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF)).build(consumer);
        DrinkRecipeBuilder.boilingRecipe(FluidIngredient.single(FluidRegistry.GREEN_TEA_STILL.get()), Ingredient.of(ItemRegister.GREEN_TEA_BAG.get())).build(consumer, "teastory:green_tea_bag");
        DrinkRecipeBuilder.drinkRecipe(FluidIngredient.single(FluidRegistry.GREEN_TEA_STILL.get()), SizedFluidIngredient.of(FluidRegistry.WEAK_GREEN_TEA_STILL.get(), 500), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF)).build(consumer, "teastory:weak_to_green_tea");
        ...
        DrinkRecipeBuilder.boilingRecipe(FluidIngredient.single(FluidRegistry.STRONG_GREEN_TEA_STILL.get()), Ingredient.of(ItemRegister.GREEN_TEA_BAG.get()), Ingredient.of(ItemRegister.GREEN_TEA_BAG.get())).build(consumer, "teastory:strong_green_tea_bag");
        DrinkRecipeBuilder.drinkRecipe(FluidIngredient.single(FluidRegistry.STRONG_GREEN_TEA_STILL.get()), SizedFluidIngredient.of(FluidRegistry.GREEN_TEA_STILL.get(), 500), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_GREEN_TEA_LEAF)).build(consumer);

        DrinkRecipeBuilder.boilingRecipe(FluidIngredient.single(FluidRegistry.WEAK_WHITE_TEA_STILL.get()), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF)).build(consumer);
        DrinkRecipeBuilder.drinkRecipe(FluidIngredient.single(FluidRegistry.WHITE_TEA_STILL.get()), SizedFluidIngredient.of(FluidRegistry.WEAK_WHITE_TEA_STILL.get(), 500), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF)).build(consumer, "teastory:weak_to_white_tea");
        ...
        DrinkRecipeBuilder.drinkRecipe(FluidIngredient.single(FluidRegistry.STRONG_WHITE_TEA_STILL.get()), SizedFluidIngredient.of(FluidRegistry.WHITE_TEA_STILL.get(), 500), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF), Ingredient.of(NormalTags.Items.CROPS_WHITE_TEA_LEAF)).build(consumer);
        ...
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(NormalTags.Items.CROPS_CUCUMBER), null, new FluidStack(FluidRegistry.CUCUMBER_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:cucumber_juice");
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(NormalTags.Items.CROPS_GRAPE), null, new FluidStack(FluidRegistry.GRAPE_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:grape_juice");
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(NormalTags.Items.CROPS_SUGAR_CANE), null, new FluidStack(FluidRegistry.SUGAR_CANE_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:sugar_cane_juice");
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(Tags.Items.CROPS_CARROT), null, new FluidStack(FluidRegistry.CARROT_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:carrot_juice");
        StoneMillRecipeBuilder.recipeWithDefaultTime(Ingredient.of(NormalTags.Items.CROPS_APPLE), null, new FluidStack(FluidRegistry.APPLE_JUICE_STILL.get(), 100), ItemStack.EMPTY).build(consumer, "teastory:apple_juice");
