...
public class TeaStoryRecipeProvider extends VanillaRecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.FOOD, ItemRegister.SPICY_BEEF_RICE_BOWL.get()).requires(ItemRegister.BEEF_RICE_BOWL.get()).requires(BlockRegister.CHILI.get()).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(output);
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.FOOD, ItemRegister.STEAMED_CHINESE_CABBAGE.get()).requires(BlockRegister.CHINESE_CABBAGE.get()).requires(BlockRegister.CHINESE_CABBAGE.get()).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(output);
        ...
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.FOOD, ItemRegister.HONEY_BITTER_GOURD.get()).requires(BlockRegister.WOODEN_BOWL_ITEM.get()).requires(BlockRegister.BITTER_GOURDS.get()).requires(Items.HONEY_BOTTLE).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(output);
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.FOOD, ItemRegister.SHREDDED_CUCUMBER_SALAD.get()).requires(BlockRegister.WOODEN_BOWL_ITEM.get()).requires(BlockRegister.CUCUMBERS.get()).requires(Items.SHEARS).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(output);
        ...
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.FOOD, ItemRegister.CHICKEN_BURGER.get()).requires(Items.BREAD).requires(Items.COOKED_CHICKEN).requires(BlockRegister.CHINESE_CABBAGE.get()).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(output);
        ShapelessRecipeBuilder.shapeless(items, RecipeCategory.FOOD, ItemRegister.BEEF_BURGER.get()).requires(Items.BREAD).requires(Items.COOKED_BEEF).requires(BlockRegister.CHINESE_CABBAGE.get()).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(output);
