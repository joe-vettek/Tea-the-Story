...
public final class TeaStoryRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ItemRegister.SHREDDED_CUCUMBER_SALAD.get()).requires(BlockRegister.WOODEN_BOWL_ITEM.get()).requires(BlockRegister.CUCUMBERS.get()).requires(Items.SHEARS).unlockedBy("has_rice", has(BlockRegister.RICE_GRAINS.get())).save(consumer);
