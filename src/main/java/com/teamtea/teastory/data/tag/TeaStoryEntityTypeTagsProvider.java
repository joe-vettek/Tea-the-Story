...
public class TeaStoryEntityTypeTagsProvider extends EntityTypeTagsProvider {
    public TeaStoryEntityTypeTagsProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> providerCompletableFuture, String modId) {
        super(packOutput, providerCompletableFuture, modId);
    }
